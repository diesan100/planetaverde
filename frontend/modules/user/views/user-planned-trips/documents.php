	...
	<div id='mycustomscroll' class='flexcroll'>
       <p class="profileHead"><i class="fa fa-user left mr10"></i>My profile</p>
        ...
        <section class="maplisting">
       		<a class="left mr15" href="#"><img alt="" src="<?=Yii::getAlias("@web")?>/images/pagoImg.jpg"></a>
        	<p class="t2">Documento 1</p>
        	<section class="editHeadz m0"><p class="t2 left">Type [ticket, reservation] |</p><a href="#" class="t2 ml5"> view</a><a href="#" class="t2 ml5"> download</a></section>
        </section>
        
        <section class="maplisting">
        	<a class="left mr15" href="#"><img alt="" src="<?=Yii::getAlias("@web")?>/images/pagoImg.jpg"></a>
        	<p class="t2">Documento 2</p>
        	<section class="editHeadz m0"><p class="t2 left">Type [ticket, reservation] |</p><a href="#" class="t2 ml5"> view</a><a href="#" class="t2 ml5"> download</a></section>
        </section>
        
        <section class="maplisting">
        	<a class="left mr15" href="#"><img alt="" src="<?=Yii::getAlias("@web")?>/images/pagoImg.jpg"></a>
        	<p class="t2">Documento 3</p>
        	<section class="editHeadz m0"><p class="t2 left">Type [ticket, reservation] |</p><a href="#" class="t2 ml5"> view</a><a href="#" class="t2 ml5"> download</a></section>
        </section>
