...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-09-2015 a las 14:52:06
...
INSERT INTO `area` (`id`, `parent`, `name`, `description`, `state`, `type`, `coords_in_parent`, `map_image`) VALUES
(1, NULL, 'World Map', 'This is the map of the world, this will be the parent container of all continents', 1, 0, '', 3),
(2, 1, 'South America', 'South America Area Descripcion', 1, 0, '111,171,115,191,118,211,119,246,125,234,135,217,144,202,150,188,154,179,142,174,136,164,124,158,112,160', 3),
(3, 1, 'Africa', 'African Continent Descripcion', 1, 0, '184,127,182,132,175,140,175,145,175,151,178,162,180,167,186,165,191,162,196,165,200,166,200,171,203,182,203,187,203,193,208,206,210,214,215,215,218,210,222,206,225,201,227,200,227,193,232,189,231,177,234,170,239,167,243,157,226,138,222,130,213,129,210,130,200,126,201,123,196,123,190,125', 5),
(5, 1, 'Asia', 'Asian Continent Descripcion', 1, 0, '270,159,271,152,281,143,285,147,293,155,300,158,303,151,299,146,305,143,314,136,314,125,312,120,300,107,283,104,268,99,259,100,251,103,247,105,246,117,243,131,245,139,256,136,262,142,265,147', NULL),
(6, 1, 'Antartica', 'Antartica continent', 1, 1, '149,255,178,250,217,258,183,264', NULL);
...
INSERT INTO `cms_category` (`ID`, `PARENT_CATEGORY`, `TITLE`) VALUES
...
--
-- Estructura de tabla para la tabla `cms_images`
--
...
--
-- Volcado de datos para la tabla `cms_images`
--

INSERT INTO `cms_images` (`ID`, `NAME`, `MIME`, `URL`, `WIDTH`, `HEIGHT`, `OWNER`, `META`, `DESCRIPTION`, `CREATED`, `UPDATED`) VALUES
(3, 'mapToggle.jpg', 'image/jpeg', 'uploads/mapToggle.jpg', 400, 270, NULL, NULL, NULL, '2015-09-04 05:15:57', '2015-09-04 05:15:57'),
(4, 'africa.png', 'image/png', 'uploads/africa.png', 400, 270, NULL, NULL, NULL, '2015-09-04 05:37:41', '2015-09-04 05:37:41'),
(5, 'africa.png', 'image/png', 'uploads/africa.png', 382, 259, NULL, NULL, NULL, '2015-09-04 05:44:02', '2015-09-04 05:44:02');
...
INSERT INTO `cms_layout` (`ID`, `LAYOUT`, `TITLE`) VALUES
(1, 'main', 'Main layout');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `cms_layout_section`
--
...
--
-- Volcado de datos para la tabla `cms_layout_section`
--

INSERT INTO `cms_layout_section` (`ID`, `NAME`, `LAYOUT`) VALUES
(1, 'header', 1),
(2, 'footer', 1),
(3, 'main-nav', 1);
...
INSERT INTO `cms_menu` (`ID`, `NAME`, `POSITION`, `TEMPLATE`) VALUES
(1, 'Main Menu', '', NULL);
...
INSERT INTO `cms_menu_item` (`MENU`, `TITLE`, `STATE`, `ID`, `PAGE`, `ORDER`, `PARENT_MENU`, `TYPE`, `URL`, `IS_HOME`) VALUES
(1, 'Home', 1, 1, 1, 1, NULL, 0, '', 1),
(1, 'Destinations', 1, 2, 8, 2, NULL, 0, '', 0),
(1, 'Wishlist', 1, 3, 10, 4, NULL, 0, '', 0),
(1, 'Contact Us', 1, 9, 11, 5, NULL, 0, '', 0),
(1, 'About Us', 1, 10, 9, 3, NULL, 0, '', 0),
(1, 'Philosophy', 1, 11, 7, 1, 10, 0, '', 0),
(1, 'Our Story', 1, 12, 12, 2, 10, 0, '', 0),
(1, 'Team', 1, 13, 13, 3, 10, 0, '', 0),
(1, 'Why', 1, 14, 14, 4, 10, 0, '', 0),
(1, 'Feedback', 1, 15, 15, 5, 10, 0, '', 0);
...
INSERT INTO `cms_page` (`ID`, `TITLE`, `CONTENT_ID`, `TYPE`, `ORDER`, `URL`, `CONTROLLER`, `METHOD`, `LAYOUT`, `IS_HOME`, `STATE`, `POST_CATEGORY`, `POST_ID`, `HEADER_IMAGE`, `HEADER_TEXT`, `SHOW_BREAD_CRUMBS`, `INTRO_TEXT`, `INTRO_IMAGE`, `HEADER_MASK`, `PARENT_PAGE`, `WRAP_CONTENT`, `CREATED_AT`, `UPDATED_AT`, `OWNER`, `MODIFIED_BY`) VALUES
(1, 'Home', 1, 4, NULL, NULL, NULL, NULL, 1, 1, 1, NULL, NULL, 2, 'Organiza y comparte tus<br>proyectos en la <strong>nube</strong><br><br>Tus archivos estarán centralizados y al alcance de todos', 0, '', NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL),
(2, 'FAQ´s', 2, 0, NULL, NULL, NULL, NULL, 1, 0, 1, NULL, NULL, NULL, '', 0, '', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL),
(3, 'Términos de uso', 3, 0, NULL, NULL, NULL, NULL, 1, 0, 1, NULL, NULL, NULL, '', 0, '', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL),
(4, 'Condiciones generales de contratación', 4, 0, NULL, NULL, NULL, NULL, 1, 0, 1, NULL, NULL, NULL, '', 0, '', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL),
(5, 'Acerca de Amazon Web Services', 5, 0, NULL, NULL, NULL, NULL, 1, 0, 1, NULL, NULL, NULL, '', 0, '', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL),
(6, 'Política de cookies', 6, 0, NULL, NULL, NULL, NULL, 1, 0, 1, NULL, NULL, NULL, '', 0, '', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL),
(7, 'Philosophy', 7, 0, NULL, NULL, NULL, NULL, 1, 0, 0, NULL, NULL, NULL, '', 0, '', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL),
(8, 'Destinations', 9, 0, NULL, NULL, NULL, NULL, 1, 0, 0, NULL, NULL, NULL, '', 0, '', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL),
(9, 'About Us', 12, 0, NULL, NULL, NULL, NULL, 1, 0, 1, NULL, NULL, NULL, '', 0, '', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL),
(10, 'Wishlist', 9, 0, NULL, NULL, NULL, NULL, 1, 0, 1, NULL, NULL, NULL, '', 0, '', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL),
(11, 'Contact', 9, 0, NULL, NULL, NULL, NULL, 1, 0, 1, NULL, NULL, NULL, '', 0, '', NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL),
(12, 'Our Story', 8, 0, NULL, NULL, NULL, NULL, 1, 0, 0, NULL, NULL, NULL, '', 0, '', NULL, NULL, 9, 0, NULL, NULL, NULL, NULL),
(13, 'Team', 9, 0, NULL, NULL, NULL, NULL, 1, 0, 1, NULL, NULL, NULL, '', 0, '', NULL, NULL, 9, 0, NULL, NULL, NULL, NULL),
(14, 'Why to travel with us', 10, 0, NULL, NULL, NULL, NULL, 1, 0, 1, NULL, NULL, NULL, '', 0, '', NULL, NULL, 9, 0, NULL, NULL, NULL, NULL),
(15, 'Feedback', 11, 0, NULL, NULL, NULL, NULL, 1, 0, 1, NULL, NULL, NULL, '', 0, '', NULL, NULL, 9, 0, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `cms_post_content`
--

CREATE TABLE IF NOT EXISTS `cms_post_content` (
  `ID` int(11) NOT NULL,
  `TITLE` varchar(255) DEFAULT NULL,
  `CONTENT` longtext,
...
--
-- Estructura de tabla para la tabla `cms_states`
--

CREATE TABLE IF NOT EXISTS `cms_states` (
  `STATE` int(11) NOT NULL DEFAULT '0',
  `STATE_NAME` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Volcado de datos para la tabla `cms_states`
--

INSERT INTO `cms_states` (`STATE`, `STATE_NAME`) VALUES
(0, 'DRAFT'),
(1, 'PUBLISHED'),
(2, 'DELETED');
...
--
-- Estructura de tabla para la tabla `cms_widget_position`
--

CREATE TABLE IF NOT EXISTS `cms_widget_position` (
...
--
-- Volcado de datos para la tabla `cms_widget_position`
--

INSERT INTO `cms_widget_position` (`WIDGET_ID`, `ORDER`, `TYPE`, `LAYOUT_SECTION`, `ID`, `PAGE`) VALUES
(1, NULL, 0, 3, 1, 1),
(2, NULL, 0, 1, 2, 1),
(3, 2, 0, 2, 3, 1);
...
--
-- Estructura de tabla para la tabla `custom_trip`
--

CREATE TABLE IF NOT EXISTS `custom_trip` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `user` int(11) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `custom_trip_extension`
--

CREATE TABLE IF NOT EXISTS `custom_trip_extension` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `group_trip`
--
...
--
-- Estructura de tabla para la tabla `lodge`
--
...
CREATE TABLE IF NOT EXISTS `lodge` (
  ...
  `poll_rate` decimal(2,2) NOT NULL DEFAULT '0.00'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `settings` (`group_name`, `param_name`, `param_type`, `param_int_value`, `param_varchar_value`, `param_long_value`, `description`) VALUES
('areas-settings', 'area-worldmap-id', 1, 1, '', '', 'This is the ID of the Word Wide map. This is the ancestor for every other map and this variable is used to show the right map in the Destination entry page and at the Home.'),
('front-page', 'facebook-link', 2, NULL, 'http://www.facebook.com', '', 'Enlace para Facebook en el pie'),
('front-page', 'google-analytics', 3, NULL, '', '<script>\r\n  (function(i,s,o,g,r,a,m){i[''GoogleAnalyticsObject'']=r;i[r]=i[r]||function(){\r\n  (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),\r\n  m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)\r\n  })(window,document,''script'',''//www.google-analytics.com/analytics.js'',''ga'');\r\n \r\n  ga(''create'', ''UA-63585728-1'', ''auto'');\r\n  ga(''send'', ''pageview'');\r\n \r\n</script>', 'Códido de seguimiento de google analitycs proporcionado por google.'),
('admin-emails', 'info-address', 2, NULL, 'info@myprojectt.com', '', 'Dirección de correo dónde se enviaran las comunicaciones al adminsitrador de la aplicación.'),
('tasks-module', 'log-file-path', 2, NULL, './tasks.log', '', 'Path para el fichero de logs del módulo de tareas ejecutadas diariamente.'),
('front-page', 'meta-description', 2, NULL, 'Comparte tus proyectos online. Tus documentos centralizados y al alcance de todos. Recibe avisos automáticos con cada revisión de tus archivos o planos', '', 'Meta descripción del sitio en la front page'),
('front-page', 'meta-words', 3, NULL, '', 'Software gestión de proyectos, Compartir proyectos online, Compartir proyectos nube, Gestión proyectos online, Gestión proyectos nube, Proyectos online, Programa compartir proyectos, Web compartir proyectos, Gestión documentos online, Gestión documental online', 'Meta tags para la portada');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `trip_album`
--

CREATE TABLE IF NOT EXISTS `trip_album` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `user` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `trip_documents`
--
...
--
-- Estructura de tabla para la tabla `trip_pictures`
--
...
INSERT INTO `user` (`id`, `type`, `email`, `name`, `surname`, `password`, `state`, `creation_date`, `last_acces`, `status`, `username`, `created_at`, `updated_at`, `auth_key`, `password_hash`, `password_reset_token`, `picture_url`, `company`, `about_me`, `professional_experience`, `studies`, `birthday`, `job_position`, `employment`, `zip_code`, `province`, `address`, `telephone`, `skype`, `gender_male`, `website`, `city`, `twitter`, `linkedin`, `google_plus`, `github`, `facebook`) VALUES
(1, 2, 'diego2.sanz@gmail.com', 'Diego', 'Sanz Prieto', NULL, NULL, NULL, NULL, 10, 'diego2', 1422706304, 2147483647, 'tcBJgvmk0PAL6Xa_qR-ztS5VfbsnMfZI', '$2y$13$pp742knvvpkcaIji2UYex.cI3j2vfsoH/TcgDSoBNozlfDvFSvlba', NULL, '/uploads/1/diego.jpg', 'My company', 'Soy un tipo listo', '', 'Ingneniero informático', '1979-12-13', '', '', '47140', 'Valladolid', 'avenida de la ronda, 83', '3245245254', 'diesan100', 0, '', 'Laguna de Duero', 'tttttttttt', 'linkedin', 'gggggggggggggg', 'gigit', 'https://www.facebook.com/diego.sanz.75'),
(5, 2, 'diego.sanz@gmail.com', '', '', NULL, 10, '2015-09-03 11:44:31', NULL, 10, 'diego.sanz@gmail.com', NULL, 2147483647, 'OHkiD5VmJi_zwr2j_aWpuzfK9lkUazCv', '$2y$13$M2532EoWgF/eS0Z0EBOcZeWVBtuyFuXfdsfxXlwcu96yYWtLdZmiy', NULL, '/uploads/5/diego.sanz@gmail.com.jpg', '', '', '', '', '0000-00-00', '', '', '', '', '', '', '', 0, '', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `user_trip`
--
...
ALTER TABLE `cms_category`
  ADD PRIMARY KEY (`ID`), ADD UNIQUE KEY `UK_category_ID` (`ID`), ADD KEY `FK_parent_category` (`PARENT_CATEGORY`);

--
-- Indices de la tabla `cms_images`
--
...
--
-- Indices de la tabla `cms_layout_section`
--
ALTER TABLE `cms_layout_section`
  ADD PRIMARY KEY (`ID`), ADD KEY `FK_layout_section_layout_ID` (`LAYOUT`);

--
-- Indices de la tabla `cms_menu`
--
ALTER TABLE `cms_menu`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `cms_menu_item`
--
ALTER TABLE `cms_menu_item`
  ADD PRIMARY KEY (`ID`), ADD KEY `FK_menu_item_menu_ID` (`MENU`), ADD KEY `FK_cms_menu_item_cms_page_ID` (`PAGE`), ADD KEY `FK_cms_menu_item_cms_menu_item_ID` (`PARENT_MENU`);

--
-- Indices de la tabla `cms_page`
--
ALTER TABLE `cms_page`
  ADD PRIMARY KEY (`ID`), ADD KEY `FK_menu_item_post_ID` (`CONTENT_ID`), ADD KEY `FK_page_layout_ID` (`LAYOUT`), ADD KEY `FK_page_post_content_ID` (`POST_CATEGORY`), ADD KEY `FK_cms_page_cms_post_content_ID` (`POST_ID`), ADD KEY `FK_cms_page_cms_page_ID` (`PARENT_PAGE`), ADD KEY `FK_cms_page_cms_images_ID` (`HEADER_IMAGE`), ADD KEY `FK_cms_page_cms_images_intro_ID` (`INTRO_IMAGE`), ADD KEY `FK_cms_page_header_mask_images_ID` (`HEADER_MASK`);

--
-- Indices de la tabla `cms_post_content`
--
ALTER TABLE `cms_post_content`
  ADD PRIMARY KEY (`ID`), ADD KEY `FK_post_user_ID` (`OWNER`), ADD KEY `FK_post_content_category_ID` (`CATEGORY`);

--
-- Indices de la tabla `cms_slide`
--
ALTER TABLE `cms_slide`
  ADD PRIMARY KEY (`ID`), ADD KEY `FK_slide_slider_ID` (`SLIDER`);
...
--
-- Indices de la tabla `cms_states`
--
ALTER TABLE `cms_states`
  ADD PRIMARY KEY (`STATE`);

--
-- Indices de la tabla `cms_widget_position`
--
ALTER TABLE `cms_widget_position`
  ADD PRIMARY KEY (`ID`), ADD KEY `FK_cms_widget_position_cms_layout_section_ID` (`LAYOUT_SECTION`), ADD KEY `FK_cms_widget_id_slider` (`WIDGET_ID`), ADD KEY `FK_cms_widget_position_cms_page_ID` (`PAGE`);

--
-- Indices de la tabla `custom_trip`
--
ALTER TABLE `custom_trip`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `custom_trip_extension`
--
ALTER TABLE `custom_trip_extension`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `group_trip`
--
ALTER TABLE `group_trip`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `lodge`
--
ALTER TABLE `lodge`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `settings`
  ADD PRIMARY KEY (`param_name`,`group_name`);

--
-- Indices de la tabla `trip_album`
--
ALTER TABLE `trip_album`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `trip_documents`
--
ALTER TABLE `trip_documents`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `trip_pictures`
--
ALTER TABLE `trip_pictures`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `cms_images`
--
ALTER TABLE `cms_images`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
...
--
-- AUTO_INCREMENT de la tabla `cms_layout_section`
--
ALTER TABLE `cms_layout_section`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `cms_menu`
--
ALTER TABLE `cms_menu`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `cms_menu_item`
--
ALTER TABLE `cms_menu_item`
...
ALTER TABLE `cms_page`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT de la tabla `cms_post_content`
--
ALTER TABLE `cms_post_content`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT de la tabla `cms_slide`
--
ALTER TABLE `cms_slide`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `cms_slider`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `cms_widget_position`
--
ALTER TABLE `cms_widget_position`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `custom_trip`
--
ALTER TABLE `custom_trip`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `custom_trip_extension`
--
ALTER TABLE `custom_trip_extension`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `friendship`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `group_trip`
--
ALTER TABLE `group_trip`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `lodge`
--
ALTER TABLE `lodge`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `news`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `trip_album`
--
ALTER TABLE `trip_album`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `trip_documents`
--
ALTER TABLE `trip_documents`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `trip_pictures`
--
ALTER TABLE `trip_pictures`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `user`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT de la tabla `user_trip`
--
ALTER TABLE `user_trip`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
